 ...
 */
final class Version20260922073023 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE partie ADD nul_propose_par VARCHAR(10) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE partie DROP nul_propose_par');
    }
}
