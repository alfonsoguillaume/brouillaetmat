 ...
 */
final class Version20260917092426 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE participation CHANGE resultat resultat VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE participation CHANGE resultat resultat VARCHAR(255) NOT NULL');
