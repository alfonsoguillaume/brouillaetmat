 ...
 */
final class Version20260922101221 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE match_tournoi (id INT AUTO_INCREMENT NOT NULL, resultat VARCHAR(10) NOT NULL, date_saisie DATETIME NOT NULL, tournois_id_id INT NOT NULL, joueur1_id_id INT NOT NULL, joueur2_id_id INT NOT NULL, INDEX IDX_6F0986B0B328FDC (tournois_id_id), INDEX IDX_6F0986B0C74E55FF (joueur1_id_id), INDEX IDX_6F0986B0F6A64F62 (joueur2_id_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('ALTER TABLE match_tournoi ADD CONSTRAINT FK_6F0986B0B328FDC FOREIGN KEY (tournois_id_id) REFERENCES tournois (id)');
        $this->addSql('ALTER TABLE match_tournoi ADD CONSTRAINT FK_6F0986B0C74E55FF FOREIGN KEY (joueur1_id_id) REFERENCES utilisateur (id)');
        $this->addSql('ALTER TABLE match_tournoi ADD CONSTRAINT FK_6F0986B0F6A64F62 FOREIGN KEY (joueur2_id_id) REFERENCES utilisateur (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE match_tournoi DROP FOREIGN KEY FK_6F0986B0B328FDC');
        $this->addSql('ALTER TABLE match_tournoi DROP FOREIGN KEY FK_6F0986B0C74E55FF');
        $this->addSql('ALTER TABLE match_tournoi DROP FOREIGN KEY FK_6F0986B0F6A64F62');
        $this->addSql('DROP TABLE match_tournoi');
