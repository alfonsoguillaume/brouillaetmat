 ...
 */
final class Version20260923084028 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE utilisateur ADD nouvel_email_en_attente VARCHAR(191) DEFAULT NULL, ADD token_changement_email VARCHAR(64) DEFAULT NULL, ADD token_changement_email_expire_le DATETIME DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE utilisateur DROP nouvel_email_en_attente, DROP token_changement_email, DROP token_changement_email_expire_le');
    }
}
