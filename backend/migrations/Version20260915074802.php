 ...
 */
final class Version20260915074802 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE utilisateur CHANGE email email VARCHAR(191) NOT NULL, CHANGE pseudo pseudo VARCHAR(191) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE utilisateur CHANGE email email VARCHAR(255) NOT NULL, CHANGE pseudo pseudo VARCHAR(255) NOT NULL');
    }
}
