 ...
 */
final class Version20260915070657 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE utilisateur ADD pseudo VARCHAR(255) NOT NULL, ADD telephone VARCHAR(20) DEFAULT NULL, ADD email_tuteur VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE utilisateur DROP pseudo, DROP telephone, DROP email_tuteur');
    }
}
