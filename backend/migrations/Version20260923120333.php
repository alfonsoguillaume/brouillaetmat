 ...
 */
final class Version20260923120333 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE utilisateur ADD token_reinitialisation VARCHAR(64) DEFAULT NULL, ADD token_reinitialisation_expire_le DATETIME DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE utilisateur DROP token_reinitialisation, DROP token_reinitialisation_expire_le');
    }
}
