 ...
 */
final class Version20260918084018 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE partie ADD statut VARCHAR(15) NOT NULL, ADD fen LONGTEXT DEFAULT NULL, ADD coups JSON DEFAULT NULL, ADD trait VARCHAR(10) DEFAULT NULL, ADD temps_restant_blanc INT DEFAULT NULL, ADD temps_restant_noir INT DEFAULT NULL, ADD dernier_coup_le DATETIME DEFAULT NULL, ADD dernier_signal_blanc DATETIME DEFAULT NULL, ADD dernier_signal_noir DATETIME DEFAULT NULL, CHANGE resultat resultat VARCHAR(10) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE partie DROP statut, DROP fen, DROP coups, DROP trait, DROP temps_restant_blanc, DROP temps_restant_noir, DROP dernier_coup_le, DROP dernier_signal_blanc, DROP dernier_signal_noir, CHANGE resultat resultat VARCHAR(10) NOT NULL');
    }
}
